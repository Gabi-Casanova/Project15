var path,boy,cash,diamonds,jewelry,sword,trash;
var pathImg,boyImg,cashImg,diamondsImg,jewelryImg,swordImg, trashImg;
var treasureCollection = 0;
var cashG,diamondsG,jewelryG,trashG,swordGroup;
...
function preload(){
  ...
  swordImg = loadImage("banana_peel.png");
  endImg = loadAnimation("gameOver.png");
  trashImg = loadImage("dead_fish.png")
}
...
function createtrash() {
  ...
  var trash = createSprite(Math.round(random(50, 350),0, 10, 10));
